...
import { Sphero } from "./Sparkletext";
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg">
          Reduce developer frustration and support wait times by 80% with
          APIhub’s AI-powered chatbot. Get instant answers or automated ticket
